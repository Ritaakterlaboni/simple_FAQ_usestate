...
<div className=" ">
  <div className="relative h-screen w-full bg-gradient-to-t from-purple-600 to-blue-600">
   ...
   {/* snowfalleffect dite npm react thake ai tag ta dile import kore tahole showfall hobe */}
...
{/* react snowfall end */}
     <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-xl bg-slate-300 sm:w-[500px] sm:h-[450px] w-[450px] h-[510px] p-[20px] border-transparent border rounded-lg">
      ...
      <h1 className="text-2xl font-bold mb-4">Frequently Asked Questions (FAQ)</h1>
       ...
       {/* first question */}
    <div className="font-medium" onClick={() => setShow(!show)}>1. What technologies does this project use?
      {( show &&
 ...
 {/* first question */}
  ...
  {/* second question */}
    <div onClick={() => setOpen(!open)} className="font-medium">2. How can I customize the questions and answers?
    ...
    <div className="font-normal text-[18px]">
     ...
     {/* second question */}
      ...
      {/* third question */}
    <div onClick={() => setHide(!hide)} className="font-medium">3. Is this FAQ section mobile responsive?
    {( hide && 
     <div className="font-normal text-[18px]">
       <p> <MdKeyboardDoubleArrowRight />Yes, the FAQ section is fully responsive and works well on all screen sizes including mobile devices, thanks to Tailwind CSS.</p>
     </div>
    )}
